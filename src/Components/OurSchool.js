      ...
      <div className="container-fluid p-0">
        ...
        <div className="container-fluid d-flex latest_card_box_ad p-0">
          ...
          {/* <h4 className="kalur text-center" style={{color:"black", fontWeight:"bold"}}>Our School</h4> */}
            <b>
              <p>
                <em>Shri Sant Kabeer Convent School .</em>
              </p>
            </b>
            <b>
              <p>
                <em>
                  Shri Sant Kabeer Convent School  was founded in 2017
            ...
            <h5>Shri Sant Kabeer Convent School is proud to offer:</h5>
            <ul className="px-3">
              <li>Shri Sant Kabeer Convent School  is proud to offer:</li>
            ...
            <p>
              ...
              at the Shri Sant Kabeer Convent School !
            </p>
          </div>
