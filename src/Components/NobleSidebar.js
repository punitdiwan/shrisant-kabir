    ...
    <>
      <div className="rightbad">
        ...
        <div
          ...
          >
            <a className="text-center hogbtn" style={{color:"white",}}>Shri Sant Kabeer Convent H.S. School </a>
          </div>
        ...
        <div className="nobaa nobaaa">
          ...
          <div
                ...
                >
                  Shri Sant Kabeer Convent H.S. School  was the first educational institute
